...
(function () {
    ...
    c.prototype.noConflict = function () {
        ...
        var b = this,
            c = b.replace_emoticons_with_colons(a);
        ...
        var c = 0,
            d = [],
            e = a.replace(b.rx_emoticons, function (e, f, g, h) {
                var i = c;
                c = h + e.length;
                var j = -1 !== g.indexOf("("),
                    k = -1 !== g.indexOf(")");
                if ((j || k) && -1 == d.indexOf(g) && d.push(g), k && !j) {
                    var l = a.substring(i, h);
                    if (-1 !== l.indexOf("(") && -1 === l.indexOf(")")) return e
                }
                if ("\n8)" === e) {
        ...
        if (d.length) {
            var f = d.map(b.escape_rx),
                g = new RegExp("(\\(.+)(" + f.join("|") + ")(.+\\))", "g");
        ...
        for (var b = this, c = 0; c < a.length; c++) {
            ...
            a: for (var e in b.data)
                for (var f = 0; f < b.data[e][3].length; f++)
                    if (d == b.data[e][3][f]) {
                        b.map.colons[d] = e;
                        break a
                    }
        ...
        var e = this,
            ...
            g = "",
            h = 0;
        "object" == typeof d && (g = e.replacement(d.idx, d.actual, d.wrapper), h = a + "-" + d.idx);
        var i = e.img_set;
        if (e.use_sheet && e.supports_css || e.data[a][6] & e.img_sets[e.img_set].mask || (i = "apple"), c = c || "", e.colons_mode) return ":" + e.data[a][3][0] + ":" + g;
        var j = b ? c + b + c : e.data[a][8] || c + e.data[a][3][0] + c;
        if (e.text_mode) return j + g;
        if (e.init_env(), "unified" == e.replace_mode && e.allow_native && e.data[a][0][0]) return e.data[a][0][0] + g;
        if ("softbank" == e.replace_mode && e.allow_native && e.data[a][1]) return e.data[a][1] + g;
        if ("google" == e.replace_mode && e.allow_native && e.data[a][2]) return e.data[a][2] + g;
        var k = e.data[a][7] || e.img_sets[i].path + a + ".png" + e.img_suffix,
            l = e.include_title ? ' title="' + (b || e.data[a][3][0]) + '"' : "",
            m = e.include_text ? c + (b || e.data[a][3][0]) + c : "",
            n = e.data[a][4],
            o = e.data[a][5];
        if (h && e.variations_data[h] && e.variations_data[h][2] && !e.data[a][7] && e.variations_data[h][2] & e.img_sets[e.img_set].mask && (k = e.img_sets[e.img_set].path + h + ".png", n = e.variations_data[h][0], o = e.variations_data[h][1], g = "", f = h, e.include_text && d && d.actual && d.wrapper && (m += d.wrapper + d.actual + d.wrapper)), e.supports_css) {
            if (e.use_sheet && null != n && null != o) {
                var p = 100 / (e.sheet_size - 1),
                    q = "background: url(" + e.img_sets[i].sheet + ");background-position:" + p * n + "% " + p * o + "%;background-size:" + e.sheet_size + "00%";
                return '<span class="emoji-outer emoji-sizer"><span class="emoji-inner" style="' + q + '"' + l + ' data-codepoints="' + f + '">' + m + "</span></span>" + g
            }
            return e.use_css_imgs ? '<span class="emoji emoji-' + a + '"' + l + ' data-codepoints="' + f + '">' + m + "</span>" + g : '<span class="emoji emoji-sizer" style="background-image:url(' + k + ')"' + l + ' data-codepoints="' + f + '">' + m + "</span>" + g
        }
        return '<img src="' + k + '" class="emoji" data-codepoints="' + f + '" ' + l + "/>" + g
        ...
        if (!a.inits.colons) {
            ...
            for (var b in a.data)
                for (var c = 0; c < a.data[b][3].length; c++) a.map.colons[a.data[b][3][c]] = b
            }
            ...
            if (!a.inits.unified) {
                ...
                a.map.unified = {};
                for (var c in a.data)
                    for (var d = 0; d < a.data[c][0].length; d++) b.push(a.data[c][0][d].replace("*", "\\*")), a.map.unified[a.data[c][0][d]] = c;
        ...
        }, c.prototype.sheet_size = 41, c.prototype.data = {
            "00a9": [
            ["\xa9\ufe0f", "\xa9"], "\ue24e", "\udbba\udf29", ["copyright"], 0, 0, 11, 0
        ],
            "00ae": [
            ["\xae\ufe0f", "\xae"], "\ue24f", "\udbba\udf2d", ["registered"], 0, 1, 11, 0
        ],
            "203c": [
