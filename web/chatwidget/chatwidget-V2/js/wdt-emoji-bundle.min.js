...
!function (_, e) {
    ...
    function e(e, a) {
        var o = m(e),
            s = o + a;
        _(o, a) || (e.className = s.substring(1))
    }

    function a(e, a) {
        for (var o = document.querySelectorAll(e), s = 0; s < o.length; s++) {
            var t = o[s],
                r = m(t),
                i = r + a;
            if (_(r, a)) return;
            t.className = i.substring(1)
        }
    }

    function o(e, a) {
        var o, s = m(e);
        _(e, a) && (o = s.replace(" " + a + " ", " "), e.className = o.substring(1, o.length - 1))
    }
    ...
    function s(e, a) {
        for (var o = document.querySelectorAll(e), s = 0; s < o.length; s++) {
            var t, r = o[s],
                i = m(r);
            if (!_(r, a)) return;
            t = i.replace(" " + a + " ", " "), r.className = t.substring(1, t.length - 1)
        }
    }
    ...
    t.defaults = {
        ...
        var m = g(a.target, "wdt-emoji-picker-parent");        
        t.input = m.querySelector(t.selector), E(t.popup, s(a.target)), e(t.popup, "open"), t.fillPickerPopup(), _(this, "wdt-emoji-picker-open") ? (t.closePicker(this), o(t.popup, "open"), !1) : (t.closePickers(), e(this, "wdt-emoji-picker-open"), void (this.innerHTML = t.emoji.replace_colons("<i class=\"icon-happy active\"></i>")))

        IMIGeneral.setEmojiStyle();

        return t.input

    }, t.fillPickerPopup = function () {
        var a = this;
        if (_(this.popup, "ready")) return !1;
        var o = this.popup.querySelector(".wdt-emoji-sections"),
            s = {
                Recent: [],
                Custom: []
            },
            m = [];
        for (var r in t.defaults.emojiData) t.defaults.emojiData.hasOwnProperty(r) && (n = t.defaults.emojiData[r], s[r] = n);
        for (var i = Object.keys(s).sort(function (_, e) {
            return t.defaults.sectionOrders[_] < t.defaults.sectionOrders[e] ? 1 : -1
        }), g = 0; g < i.length; g++) m[i[g]] = s[i[g]];
        for (var h in m)
            if (m.hasOwnProperty(h)) {
                ...
                if (n.length) {
                    ...
                    for (E.innerHTML = h, E.dataset.emojiGroup = h, w.dataset.emojiGroup = h, e(w, "wdt-emoji-list"), e(d, "wdt-emoji-section"), g = 0; g < n.length; g++) {
                        var I = n[g];
                        if (I.has_img_apple || I.has_img_emojione || I.has_img_google || I.has_img_twitter) {
                            var O = document.createElement("a");
                            if (e(O, "wdt-emoji"), e(O, t.getRandomPickerColor()), O.dataset.hasImgApple = I.has_img_apple, O.dataset.hasImgEmojione = I.has_img_emojione, O.dataset.hasImgGoogle = I.has_img_google, O.dataset.hasImgTwitter = I.has_img_twitter, O.dataset.wdtEmojiName = I.name, O.dataset.wdtEmojiShortnames = ":" + I.short_names.join(": :") + ":", O.dataset.wdtEmojiShortname = I.short_name, O.dataset.wdtEmojiOrder = I.sort_order, O.innerHTML = a.emoji.replace_colons(":" + I.short_name + ":"), 0 == g) w.appendChild(O), l.push(I.sort_order);
                            else {
                                var A = p(l, I.sort_order),
                                    T = w.querySelector('[data-wdt-emoji-order="' + A + '"]'),
                                    R = Array.prototype.indexOf.call(w.childNodes, T);
                                I.sort_order > A ? w.childNodes[R].insertAdjacentHTML("afterend", O.outerHTML) : w.insertBefore(O, w.childNodes[R]), l.push(I.sort_order)
                            }
                        }
                    }
                    d.appendChild(E), d.appendChild(w), o.appendChild(d)
                }
            }
        e(this.popup, "ready"), t.bindEvents()
    }, t.getRandomPickerColor = function () {
        return t.defaults.pickerColors[Math.floor(Math.random() * t.defaults.pickerColors.length)]
    }, t.close = function () {
        o(t.popup, "open"), t.closePickers()
    }, t.closePickers = function () {
        var _ = document.querySelectorAll(".wdt-emoji-picker-open");
        if (_.length)
            for (var e = 0; e < _.length; e++) t.closePicker(_[e])
    }, t.closePicker = function (_) {
        o(_, "wdt-emoji-picker-open"), _.innerHTML = this.emoji.replace_colons("<i class=\"icon-happy\"></i>")
        IMIGeneral.setEmojiStyle();
      
    }, t.bindEvents = function () {
        var _ = this,
            a = document.querySelectorAll(".wdt-emoji-section h3");
        if (a.length)
            for (var s = 0; s < a.length; s++) i(a[s]);
        d("click", ".wdt-emoji-list a.wdt-emoji", function (_) {
            var e = h(t.input);
            n(t.input, e, ":" + this.dataset.wdtEmojiShortname + ":"), l("select", {
                el: t.input,
                event: _,
                emoji: ":" + this.dataset.wdtEmojiShortname + ":"
            });
            var a = new Event("input");
            return t.input.dispatchEvent(a), t.close(), !1
        }), d("click", ".wdt-emoji-popup-mobile-closer", function (_) {
            return t.close(), !1
        }), d("mouseover", ".wdt-emoji-list a.wdt-emoji", function (a) {
            t.previewTimer && clearTimeout(t.previewTimer), t.previewExitTimer && clearTimeout(t.previewExitTimer);
            var o = this;
            return t.previewTimer = setTimeout(function () {
                e(t.popup, "preview-mode"), t.previewImg.innerHTML = _.emoji.replace_colons(":" + o.dataset.wdtEmojiShortname + ":"), t.previewName.innerHTML = o.dataset.wdtEmojiShortname, t.previewAliases.innerHTML = o.dataset.wdtEmojiShortnames
            }, 100), !1
        }), d("mouseout", ".wdt-emoji-list a.wdt-emoji", function () {
            return t.previewExitTimer && clearTimeout(t.previewExitTimer), t.previewExitTimer = setTimeout(function () {
                o(t.popup, "preview-mode")
            }, 1e3), !1
        }), d("click", ".wdt-emoji-tab", function (_) {
            var e = this.dataset.groupName,
                a = t.popup.querySelector('.wdt-emoji-section h3[data-emoji-group="' + e + '"]');
            return a && (t.setActiveTab(e), t.scroller.scrollTop = a.offsetTop - a.getBoundingClientRect().height - 2), !1
        }), d("input", "#wdt-emoji-search", function (_) {
            var e = this;
        ...
        var m = t.popup.querySelector(".wdt-emoji-sections"),
            r = t.popup.querySelector("#wdt-emoji-search-result-title"),
            i = m.querySelectorAll(".wdt-emoji"),
            g = t.popup.querySelector("#wdt-emoji-no-result"),
            h = 0;
        if ("" == _) return o(r, "wdt-show"), o(g, "wdt-show"), s(".wdt-emoji.not-matched", "not-matched"), s(".wdt-emoji-section", "wdt-inline"), s(".wdt-emoji-list", "wdt-inline"), s(".wdt-emoji-section h3", "wdt-search-on"), !1;
        for (var n = 0; n < i.length; n++) {
            var l = i[n],
                p = l.dataset.wdtEmojiName + " " + l.dataset.wdtEmojiShortnames;
            o(l, "not-matched"), p.match(new RegExp(_, "gi")) ? h++ : e(l, "not-matched")
        }
        e(r, "wdt-show"), a(".wdt-emoji-section", "wdt-inline"), a(".wdt-emoji-list", "wdt-inline"),
            a(".wdt-emoji-section h3", "wdt-search-on"), h ? o(g, "wdt-show") : e(g, "wdt-show")
    }, t.dispatchHandlers = {
        select: [],
        afterSelect: [],
        afterPickerOpen: []
        ...
        switch (_) {
            case "select":
                return t.dispatchHandlers.select.push(e);
            case "afterSelect":
                return t.dispatchHandlers.afterSelect.push(e);
            case "afterPickerOpen":
                return t.dispatchHandlers.afterPickerOpen.push(e);
            default:
                console.error("wdt-emoji-bundle - Not supported event type!", _)
        }
    }, t.changeType = function (_) {
        var e, a = t.defaults.emojiSheets[_],
            o = document.querySelectorAll(".emoji-inner");
        ...
        t.defaults.emojiType = _, document.querySelector("body").dataset.wdtEmojiBundle = _, this.emoji.img_set = _
    }, t.changeSkinColor = function (_) { }, t.render = function (_) {
        return this.emoji.replace_colons(this.emoji.replace_emoticons(this.emoji.replace_unified(_)))
    }, t.addRangeStore = function (_) {
        _.addEventListener("focus", function () {
            var _ = window.getSelection();
            t.ranges[this.dataset.rangeIndex] ? _.rangeCount > 0 && (_.removeAllRanges(), _.addRange(t.ranges[this.dataset.rangeIndex])) : t.ranges[this.dataset.rangeIndex] = new Range
        }), r(_, "mouseup keyup", function () {
            t.ranges[this.dataset.rangeIndex] = window.getSelection().getRangeAt(0)
    ...
    var r = function (_, e, a) {
        e = e.split(" ");
        for (var o = 0; o < e.length; o++) _.addEventListener(e[o], a, !1)
    },
        i = function (a) {
            function s() {
                var s = t.scroller.scrollTop;
                if (_(a, "sticky") && r > s) o(a, "sticky"), E(a, {
                    top: null
                }), E(a.parentNode, {
                    "padding-top": null
                });
                else if (s > r && !_(a, "sticky")) {
                    var m = document.querySelectorAll(".wdt-emoji-section h3");
                    if (m.length)
                        for (var g = 0; g < m.length; g++) o(m[g], "sticky"), E(m[g], {
                            top: null
                        }), E(m[g].parentNode, {
                            "padding-top": null
                        });
                    e(a, "sticky"), E(a, {
                        ...
                        "padding-top": a.getBoundingClientRect().height + "px"
                    }), t.setActiveTab(a.dataset.emojiGroup)
                }
            }
            var m = t.scroller.getBoundingClientRect(),
                r = a.getBoundingClientRect().top - m.top,
                i = t.popup.querySelector("#wdt-emoji-menu-header").getBoundingClientRect().height;
            t.scroller.addEventListener("scroll", s)
        };
    t.setActiveTab = function (_) {
        var a = document.querySelectorAll(".wdt-emoji-tab");
        if (a.length)
            for (var s = 0; s < a.length; s++) o(a[s], "active");
        var m = t.popup.querySelector('.wdt-emoji-tab[data-group-name="' + _ + '"]');
        e(m, "active")
    };
    var g = function (_, e) {
        for (;
        ...
        h = function (_) {
            ...
            if (window.getSelection) {
                ...
                var r = document.selection.createRange(),
                    i = _.value || _.innerHTML,
                    g = r.duplicate();
                g.moveToElementText(_), g.setEndPoint("EndToEnd", r), _.selectionStart = g.text.length - r.text.length, _.selectionEnd = _.selectionStart + r.text.length, e = {
                    el: _,
        ...
        n = function (_, e, a) {
            ...
            e.ce ? (_.focus(), document.execCommand("insertText", !1, a)) : (_.value = o.substring(0, e.start) + a + o.substring(e.end, e.len), _.selectionStart = _.selectionEnd = e.start + a.length, _.focus())
        },
        l = function (_, e) {
            var a, o, s, m;
            for (m = t.dispatchHandlers[_], o = 0, s = m.length; s > o; o++) (a = m[o])(e)
        },
        p = function (_, e) {
        ...
        E = function () {
            ...
            function e(_) {
                ...
                if (_ in e) return _;
                for (var a, o = s.length, m = _.charAt(0).toUpperCase() + _.slice(1); o--; )
                    if (a = s[o] + m, a in e) return a;
                return _
            }

            function a(a) {
                return a = _(a), m[a] || (m[a] = e(a))
            }
            ...
            return function (_, e) {
                var a, s, m = arguments;
                if (2 == m.length)
                    for (a in e) s = e[a], void 0 !== s && e.hasOwnProperty(a) && o(_, a, s);
                else o(_, m[1], m[2])
            }
        } ();
    return t
