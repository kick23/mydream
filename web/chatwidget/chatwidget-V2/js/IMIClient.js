...
var authdomain = "https://qa-rtm.imimobile.net/rtmsAPI";
var rtmsdomain = "qa-rtmmsg.imimobile.net";
var safariRegisterURL = 'https://qa-rtm.imimobile.net/apnpweb/';
        ...
        obj = {
            ...
            shutdown: function () {
                try {
                    ...
                    try {
                        if (_imiconnect && _imiconnect.webpush) {
            ...
            updateUserId: function (userId, callback) {
                ...
                var requestData = JSON.stringify(userUpdateJSON);
                var headers = {
                    'Content-Type': 'application/json',
                    'secretKey': _imiconnect.appSecret
                };
            ...
            updateCustomerId: function (customerId, callback) {
                ...
                var requestData = JSON.stringify(customerUpdateJSON);
                var headers = {
                    'Content-Type': 'application/json',
                    'secretKey': _imiconnect.appSecret
                };
            ...
            removeUserId: function (callback) {
                ...
                var requestData = JSON.stringify(removeUserIdJSON);
                var headers = {
                    'Content-Type': 'application/json',
                    'secretKey': _imiconnect.appSecret
                };
            ...
            removeCustomerId: function (callback) {
                ...
                var reqbody = JSON.stringify(removeCustJSON);
                var headers = {
                    'Content-Type': 'application/json',
                    'secretKey': _imiconnect.appSecret
                };
            ...
            deRegisterDeviceProfile: function (callback) {
                ...
                var unRegDevProfReq = JSON.stringify(deRegisterJSON);
                var headers = {
                    'Content-Type': 'application/json',
                    'secretKey': _imiconnect.appSecret
                };
        ...
        function init() {
            ...
            var messagingInstanceObj = {
                ...
                updateThread: function (icThreadObj, callback) {
                    ...
                    var user = _imiconnect.iCDeviceProfile.userId || "";
                    var updateThreadUrl = rtmsAPIURL + "/apps/" + _imiconnect.appName + "/user/" + user + "/threads/" + icThreadObj.getId() ;
                ...
                fetchThreads: function (offset, callback) {
                    ...
                    var fetchThreadsURL = rtmsAPIURL + "/apps/" + _imiconnect.appName + "/user/" + _imiconnect.iCDeviceProfile.userId + "/threads?start=" + offset;
                            ...
                            success: function (publishResp) {
                                if (publishResp && publishResp.code == "0") {
                                    if (callback && typeof (callback.onSuccess) === "function") {
                                        callback.onSuccess(IMI.MessageStatus.messagesuccess,publishResp);
                                    }
                                } else {
...
//                            var encData = encodeURIComponent(_imiconnect._encryptMsg(payLoad));
                ...
                subscribeTopic: function (topicId, callback) {
                    ...
                    var subscribeTopicURL = rtmsAPIURL + "/apps/" + _imiconnect.appName + "/topics/" + topicId + "/users";
                    var headers = {};
                    var headers = {
                        'Content-Type': 'application/json',
                        'secretKey': _imiconnect.appSecret
                ...
                unsubscribeTopic: function (topicId, callback) {
                    ...
                    //fetching user threads
                    var unsubscribeTopicURL = rtmsAPIURL + "/apps/" + _imiconnect.appName + "/topics/" + topicId + "/users/" + userId;
                    var headers = {};
                    var headers = {
                        'Content-Type': 'application/json',
                        'secretKey': _imiconnect.appSecret
